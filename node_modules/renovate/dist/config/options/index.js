...
const dockerVersioning = tslib_1.__importStar(require("../../modules/versioning/docker"));
const options = [
    {
    ...
    },
    {
        ...
        description: 'Set this to `true` to allow templating for post-upgrade commands.',
        type: 'boolean',
        default: false,
        globalOnly: true,
    },
    ...
    },
    {
        ...
        description: 'Change this value to override the default Renovate Docker sidecar image name prefix.',
        type: 'string',
    ...
    {
        name: 'includeForks',
        description: 'Whether to process forked repositories. By default, all forked repositories are skipped.',
        stage: 'repository',
        type: 'boolean',
        default: false,
    },
    ...
    {
        name: 'ignoreScripts',
        description: 'Set this to `true` if `allowScripts=true` but you wish to skip running scripts when updating lock files.',
        type: 'boolean',
        default: false,
    ...
    },
    {
        ...
        default: constants_1.PlatformId.Github,
        globalOnly: true,
    },
    {
        name: 'endpoint',
    ...
    {
        name: 'matchLanguages',
        description: 'List of languages to match (e.g. `["python"]`). Valid only within a `packageRules` object.',
        type: 'array',
        subType: 'string',
        allowString: true,
        parent: 'packageRules',
    ...
    {
        name: 'stabilityDays',
        description: 'Number of days required before a new release is considered stable.',
        type: 'integer',
        default: 0,
    },
    /*
    ...
    */
    ...
    },
    {
        ...
        type: 'string',
        default: 'to {{#if isPinDigest}}{{{newDigestShort}}}{{else}}{{#if isMajor}}v{{{newMajor}}}{{else}}{{#if isSingleVersion}}v{{{newVersion}}}{{else}}{{#if newValue}}{{{newValue}}}{{else}}{{{newDigestShort}}}{{/if}}{{/if}}{{/if}}{{/if}}',
        cli: false,
    },
    {
