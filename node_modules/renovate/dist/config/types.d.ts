...
export declare type DryRunConfig = 'extract' | 'lookup' | 'full';
export declare type RequiredConfig = 'required' | 'optional' | 'ignored';
...
export declare type UpdateConfig<T extends RenovateSharedConfig = RenovateSharedConfig> = Partial<Record<UpdateType, T | null>>;
...
export declare type UseBaseBranchConfigType = 'merge' | 'none';
...
export declare type UpdateType = 'major' | 'minor' | 'patch' | 'pin' | 'digest' | 'pinDigest' | 'lockFileMaintenance' | 'lockfileUpdate' | 'rollback' | 'bump' | 'replacement';
